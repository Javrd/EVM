...
CREATE TABLE USUARIOS
	...
	EMAIL VARCHAR2(60),
	TELEFONO NUMBER(9),
	DERECHOS_DE_IMAGEN NUMBER(1) CHECK(DERECHOS_DE_IMAGEN=1 OR DERECHOS_DE_IMAGEN=0),
	PRIMARY KEY (OID_U)
	);
...
CREATE TABLE FALTAS
	(
	OID_F NUMBER(3),
	TIPO_DE_FALTA VARCHAR2(10) CHECK(TIPO_DE_FALTA='Pago' OR TIPO_DE_FALTA='Asistencia'),
	FECHA_DE_FALTA DATE,
...
CREATE TABLE INSTRUMENTOS
	...
	NOMBRE VARCHAR2(50),
	ESTADO_DE_INSTRUMENTO VARCHAR2(11) CHECK(ESTADO_DE_INSTRUMENTO='Nuevo' OR ESTADO_DE_INSTRUMENTO='Usado' OR ESTADO_DE_INSTRUMENTO='Deteriorado'),
	PRIMARY KEY (OID_I)
	);
